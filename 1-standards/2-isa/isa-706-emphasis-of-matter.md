---
title: "ISA 706 — Emphasis of Matter Paragraphs and Other Matter Paragraphs in the Independent Auditor's Report"
type: entity
created: 2026-04-07
updated: 2026-04-07
tags: [standards, isa, iaasb, reporting, emphasis-of-matter]
ref: "ISA 706"
status: active
---
...
### Other Matter Paragraphs (paras 10-11)
...
- If the auditor expects to include an Emphasis of Matter or Other Matter paragraph, the auditor shall communicate this expectation and the proposed wording to those charged with governance.

### Relationship with Key Audit Matters

- When ISA 701 applies, Emphasis of Matter paragraphs are not a substitute for describing individual key audit matters.
- Matters determined to be key audit matters may also be fundamental to users' understanding; in such cases, the auditor may highlight them more prominently within the Key Audit Matters section rather than using a separate Emphasis of Matter paragraph.
- A matter that is not a key audit matter (because it did not require significant auditor attention) may still warrant an Emphasis of Matter paragraph if fundamental to users' understanding (e.g., a subsequent event).
...
No specific Probe working papers are currently mapped to ISA 706. The standard's requirements would be applied through [[2-working-papers/1-finalisation/02-50-assurance-report/02-50-assurance-report]] (Consideration of Assurance Report) when additional paragraphs are needed in the auditor's report.
...
- IAASB 2025 Handbook, Volume 1, pages 667-679
