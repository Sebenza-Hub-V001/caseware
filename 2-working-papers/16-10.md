...
- [[2-working-papers/18-10]] — Financial Statement Preparation Work Program (uses the records verified here)
- [[2-working-papers/17-10]] — Opening Balances and Comparatives Work Program (relies on prior year records)

## References

- CaseView source: `raw/caseview-documents/16.10 Accounting Records Work Program CaseView Document.pdf`
