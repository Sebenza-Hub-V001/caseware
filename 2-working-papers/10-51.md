...
- Decision on whether to document per-COTABD or consolidated is made at Q7 in [[2-working-papers/10-50]]
- Q8 in [[2-working-papers/10-50]] determines whether 10.52 analytical procedures supplement or replace this document
- Risk indicators from this document feed into [[2-working-papers/11-10]] and the inherent risk assessment at [[2-working-papers/11-20]]
...
- CaseView source: `raw/caseview-documents/10.51 Types and Volumes of Transactions.pdf`
...
- [[2-working-papers/10-50]] — Gathering information (drives scope and documentation approach)
- [[2-working-papers/10-60]] — Overall materiality (materiality benchmarks for significance)
- [[2-working-papers/11-10]] — Risk analysis summary (ROMM identified here flows to risk analysis)
- [[2-working-papers/11-20]] — Inherent risk assessment (inherent risk per COTABD)
