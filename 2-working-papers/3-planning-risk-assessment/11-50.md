...
- CaseView source: [[raw/caseview-documents/planning-risk-assessment/11.50 - Information System and Control Activities CaseView Document.pdf]]
- CaseView source: [[raw/caseview-documents/planning-risk-assessment/11.50 Information System and Control Activities.pdf]]
...
- The journal entry controls documented here are referenced by [[2-working-papers/planning-risk-assessment/11-25]] (fraud risk assessment) for the management override of controls risk.
- For each revenue stream (up to 3), the auditor must either document the control addressing the presumed fraud risk or rebut the presumption with documented reasons (rebuttal is recorded on [[2-working-papers/planning-risk-assessment/11-60]]).
...
- [[2-working-papers/planning-risk-assessment/11-25]] — Fraud Risk Assessment (references journal entry controls documented here)
- [[2-working-papers/planning-risk-assessment/11-30]] — Evaluation of System of Internal Control (broader control assessment)
- [[2-working-papers/planning-risk-assessment/11-60]] — Risk Assessment at Assertion Level (revenue fraud risk rebuttal recorded there)
...
## References
- CaseView source: [[raw/caseview-documents/planning-risk-assessment/11.50 - Information System and Control Activities CaseView Document.pdf]]
- CaseView source (alternate version): [[raw/caseview-documents/planning-risk-assessment/11.50 Information System and Control Activities.pdf]]
- Probe interface screenshot: [[raw/caseview-documents/planning-risk-assessment/ProbeAuditPremium - Audit Single Version XXXX 20 23 - Information system and control activities.pdf]]
