...
- The journal entry controls documented here are referenced by [[working-papers/11-25]] (fraud risk assessment) for the management override of controls risk.
- For each revenue stream (up to 3), the auditor must either document the control addressing the presumed fraud risk or rebut the presumption with documented reasons (rebuttal is recorded on [[working-papers/11-60]]).
...
- [[working-papers/11-25]] — Fraud Risk Assessment (references journal entry controls documented here)
- [[working-papers/11-30]] — Evaluation of System of Internal Control (broader control assessment)
- [[working-papers/11-60]] — Risk Assessment at Assertion Level (revenue fraud risk rebuttal recorded there)
