...
- Populate the planned hours by audit area/team member based on the risk assessment and engagement complexity determined in [[2-working-papers/10-20]]
- The budget should reflect the desired audit risk level and materiality set in [[2-working-papers/10-60]]
- Compare against prior year to identify significant changes and ensure adequate resourcing
- The fee estimate in the engagement letter ([[2-working-papers/10-21]]) should be consistent with this budget
...
- CaseView source: `raw/caseview-documents/10.40 Time Budget CaseView Document.pdf`
...
- [[2-working-papers/10-20]] — Engagement evaluation (engagement complexity drives budget)
- [[2-working-papers/10-21]] — Engagement letter (fee estimates should align)
