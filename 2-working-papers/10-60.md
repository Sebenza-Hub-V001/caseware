...
- **Performance materiality (Q3)** — Derived from overall materiality and desired audit risk
  - Linked to Desired Audit Risk set in [[working-papers/10-20]]
...
- Complete after [[working-papers/10-20]] (which sets the Desired Audit Risk) and after financial data is available
...
- Overall materiality flows into [[working-papers/11-10]] where it appears as performance materiality per COTABD
- Consider whether specific materiality is needed for particular COTABDs (set in [[working-papers/11-10]])
...
- [[working-papers/10-20]] — Engagement evaluation (sets Desired Audit Risk used for performance materiality)
- [[working-papers/10-51]] — Types and volumes of transactions (financial data context)
- [[working-papers/11-10]] — Risk analysis summary (materiality applied per COTABD)
- [[working-papers/02-40]] — Evaluation of misstatements (materiality used to evaluate detected misstatements)
