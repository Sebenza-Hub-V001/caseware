...
- **Performance materiality (Q3)** — Derived from overall materiality and desired audit risk
  - Linked to Desired Audit Risk set in [[2-working-papers/10-20]]
...
- Complete after [[2-working-papers/10-20]] (which sets the Desired Audit Risk) and after financial data is available
...
- Overall materiality flows into [[2-working-papers/11-10]] where it appears as performance materiality per COTABD
- Consider whether specific materiality is needed for particular COTABDs (set in [[2-working-papers/11-10]])
...
- CaseView source: [[raw/caseview-documents/10.60 Overall Materiality Assessment CaseView Document.pdf]]
...
- [[2-working-papers/10-20]] — Engagement evaluation (sets Desired Audit Risk used for performance materiality)
- [[2-working-papers/10-51]] — Types and volumes of transactions (financial data context)
- [[2-working-papers/11-10]] — Risk analysis summary (materiality applied per COTABD)
- [[2-working-papers/02-40]] — Evaluation of misstatements (materiality used to evaluate detected misstatements)
