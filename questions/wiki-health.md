...
- [ ] 10.30 — Discussions with those charged with governance (has a wiki page at [[2-working-papers/pre-engagement-planning/10-31]] but 10.30 is listed separately in progress tracker)
...
> **Note:** Three additional Leadsheets items (Sections work programs, General work programs, Probe Firm settings, All Probe features, Minutes/01.60) appear in the tracker. Minutes has a page at [[2-working-papers/finalisation/01-60]]; the others have no reference number and no wiki page.
