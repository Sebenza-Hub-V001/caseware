...
- Decision on whether to document per-COTABD or consolidated is made at Q7 in [[working-papers/10-50]]
- Q8 in [[working-papers/10-50]] determines whether 10.52 analytical procedures supplement or replace this document
- Risk indicators from this document feed into [[working-papers/11-10]] and the inherent risk assessment at [[working-papers/11-20]]
...
- [[working-papers/10-50]] — Gathering information (drives scope and documentation approach)
- [[working-papers/10-60]] — Overall materiality (materiality benchmarks for significance)
- [[working-papers/11-10]] — Risk analysis summary (ROMM identified here flows to risk analysis)
- [[working-papers/11-20]] — Inherent risk assessment (inherent risk per COTABD)
