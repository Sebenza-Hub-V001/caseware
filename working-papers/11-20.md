...
- The conclusion at item 22 requires an overall inherent risk assessment at the financial statement level, which flows to [[working-papers/11-10]].
...
## Related
- [[working-papers/11-10]] — Risk Analysis Summary (receives the financial statement level assessment)
- [[working-papers/11-25]] — Fraud Risk Assessment (complementary assessment)
- [[working-papers/11-30]] — Evaluation of System of Internal Control (complementary assessment)
- [[working-papers/11-60]] — Risk Assessment at Assertion Level (detailed assertion-level assessment)
